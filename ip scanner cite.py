...
try:
    ...
    print(Colorate.Horizontal(Colors.blue_to_red, f"Website : {website_url}"))

    domain = domain_scan(website_url)
    print(Colorate.Horizontal(Colors.blue_to_red, f"Domain : {domain}"))

    secure = secure_scan(website_url)
    print(Colorate.Horizontal(Colors.blue_to_red, f"Secure : {secure}"))

    status_code = status_scan(website_url)
    print(Colorate.Horizontal(Colors.blue_to_red, f"Status Code : {status_code}"))

    ip, ip_status, host_isp, host_org, host_as = ip_scan(domain)
    print(Colorate.Horizontal(Colors.blue_to_red, f"Ip : {ip}"))
    print(Colorate.Horizontal(Colors.blue_to_red, f"Ip Status : {ip_status}"))
